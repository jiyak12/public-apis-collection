...
| [AirportsAPI](https://airportsapi.io) | <details><summary>Airport lookup by ICAO/IATA codes</summary>Retrieve airport names, cities, countries, coordinates, and timezone data. Useful for flight booking, routing info, or trip planners.</details> | No | Medium | Tourism |
...
| [RoadGoat Cities](https://roadgoat.com/developer) | <details><summary>Destination data hub</summary>Offers travel guides, safety ratings, COVID stats, photos & booking links for 4M+ cities worldwide—perfect for rich location insights in itinerary apps.</details> | API Key | Medium | Tourism |
...
| [Visitmoov](https://api.visitmoov.com) | <details><summary>Tailor-made tourist itinerary planner</summary>Create optimized travel routes and curated POI visits based on preferences, real-time transport, crowd data, and timing.</details> | API Key (free tier) | Medium | Tourism |
...
| API | Description | Auth | Difficulty |
|-----|-------------|------|------------|
| [AirportsAPI](https://airportsapi.io) | <details><summary>Airport lookup by ICAO/IATA codes</summary>Retrieve airport names, cities, countries, coordinates, and timezone data. Useful for flight booking, routing info, or trip planners.</details> | No | Medium |
| [BlaBlaCar](https://dev.blablacar.com) | <details><summary>Carpooling search and booking</summary>Search available rides, routes, prices and book shared car journeys. Helps integrate budget-friendly, eco-friendly transport.</details> | API Key | Medium |
| [GetYourGuide](https://partner.getyourguide.com/api) | <details><summary>Tours & activities booking API</summary>Search global tours/experiences, check availability, pricing, and enable bookings directly in-app.</details> | API Key | Medium |
| [GraphHopper](https://www.graphhopper.com/products/) | <details><summary>Route planning & navigation</summary>Provide routes for driving, biking, walking, calculate isochrones and matrix; great for travel planning and mapping.</details> | API Key | Medium |
| [RoadGoat Cities](https://roadgoat.com/developer) | <details><summary>Destination data hub</summary>Offers travel guides, safety ratings, COVID stats, photos & booking links for 4M+ cities worldwide—perfect for rich location insights in itinerary apps.</details> | API Key | Medium |
| [Tiqets](https://www.tiqets.com/api) | <details><summary>Tickets for museums, galleries & attractions</summary>Discover ticket availability, venue info, and book experiences across global destinations—ideal for integrating attraction bookings in travel apps.</details> | API Key | Medium |
| [Tourism Info Hub (Singapore)](https://tih-dev.stb.gov.sg/open-data-service-api) | <details><summary>Singapore tourism open-data API</summary>Access datasets like accommodations, attractions, events, malls, walking trails & visitor stats—all through REST endpoints.</details> | API Key | Medium |
| [Travel Briefing](https://travelbriefing.org) | <details><summary>Destination-specific travel information</summary>Access essential data for travelers including visa requirements, local weather, currency exchange, vaccination info, and more for any country. Useful for building travel apps, itinerary planners, or tourism dashboards.</details> | No | Medium |
| [Visitmoov](https://api.visitmoov.com) | <details><summary>Tailor-made tourist itinerary planner</summary>Create optimized travel routes and curated POI visits based on preferences, real-time transport, crowd data, and timing.</details> | API Key | Medium |
| [Windy Webcams](https://windy.com/webcams) | <details><summary>Global live webcam streams</summary>Embed live webcam feeds from thousands of locations worldwide—great for real-time weather visuals, destination previews, and travel ambience features.</details> | No | Medium |
